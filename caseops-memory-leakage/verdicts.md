...
|---|---:|---|
| **CLEAN** | 8 | #1729, #1851, #1868, #1908, #2019, #2027 (non-CaseOps), #2031, #2068 |
| **LEAK** | 25 | #1736, #1769, #1787, #1797, #1855, #1923, #1945, #1953, #1967, #2007, #2014, #2018, #2041, #2060, #2071 (symlink), #2075, #2078, #2100, #2101, #2109 (custom variant), #2117, #2118, #2121, #2123, #2124 |
...
| **#1945** | @alertcat | 2026-04-29 | 1.05943 | #1855, #1908, #1923 | `/workspace/caseops_data/datasets/datasets/...v1_reserved` | 80 | 47,852,288 | **LEAK** | val10k-train+50k-val-regen | "V21" = #1855 + AWQ-lite + AsymLogit. Same prep workflow. (val_tokens off by 768 from canonical 47,851,520 — alignment artifact, not a different val.) |
| **#1953** | @andrewbaggio1 | 2026-04-30 | 1.05855 | #1945 | `/workspace/caseops_data/datasets/datasets/...v1_reserved` | 80 | 47,851,520 | **LEAK** | val10k-train+50k-val-regen | V21 + TTT tweaks. Same prep as parent. |
...
| **#2014** | @simonbissonnette | 2026-04-30 | 1.05759 | #1855, #1953 | `/dev/shm/pgolf_caseops_data_80_l17_final` | ? | ? | **LEAK** | val10k-train+50k-val-regen | README: "uses same shards as PR #1855" (LEAK). `_80_` in path name → 80 × 10M-token leaky shards staged to /dev/shm. |
...
| **#2041** | @jorge-asenjo | 2026-04-30 | 1.05692 | #1945, #1967, #2018 | `/workspace/pg-data/datasets/datasets/...v1_reserved` | 80 | 47,851,520 | **LEAK** | val10k-train+50k-val-regen | V21 + Inside-timer N-gram TTT. Same lineage prep. |
...
| **#2075** | @deusexnatura | 2026-04-30 | (no claim) | #1855 | `/workspace/caseops_data/datasets/datasets/...v1_reserved` | ? | ? | **LEAK** | val10k-train+50k-val-regen | PairGeom-V on #1855. Ships `prepare_caseops_data.py` with default args. |
