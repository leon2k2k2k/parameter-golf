...
| **LEAK** | 21 | #1736, #1769, #1787, #1797, #1855, #1923, #1967, #2007, #2014, #2018, #2060, #2071 (symlink), #2078, #2100, #2101, #2109 (custom variant), #2117, #2118, #2121, #2123, #2124 |
| **AMBIGUOUS** | 3 | **#1953, #2041, #2075** *(re-audit: no direct prep evidence in PR; path matches both HF and local-prep; LEAK call was over-confident)* |
