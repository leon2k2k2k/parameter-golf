...
`028` showed that TTT hyperparameters matter on top of the same frozen `026 seed_42` float checkpoint:
...
- if `033` beats `028B`, then frozen training-time carry is not fully TTT-optimal
