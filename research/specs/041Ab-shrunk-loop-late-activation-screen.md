# Spec 041Ab — shrunk loop (layers 4-5), NUM_LOOPS=2, frac=0.63

**Slug:** `041Ab-shrunk-loop-late-activation-screen`
**Created:** 2026-04-25
**Status:** READY
...
export RUN_ID="041Ab-shrunk-loop-late-activation"

mkdir -p /workspace/runs/041Ab-shrunk-loop-late-activation-screen
...
torchrun --standalone --nproc_per_node=4 \
  ...
  >> /workspace/runs/041Ab-shrunk-loop-late-activation-screen/train.log 2>&1
```
