# Spec 041J — loop layers 4-5, NUM_LOOPS=2, frac=0.30

**Slug:** `041J-loop45-frac030-screen`
**Created:** 2026-04-26
**Status:** READY
...
Midpoint between 041I (frac=0.25) and 041H (frac=0.35). Same N=15 config (layers 4-5,
NL=2). Fills out the frac curve to find the optimal activation timing.

- No-loop phase: 0.30 × 1200 × 5.495 = **~1978 steps**
- Loop phase: 0.70 × 1200 × 4.167 = **~3500 loop steps**
- Total: **~5478 steps**
- Predicted val_bpb: 1.06514 - (3500-2867)×2.2e-6 = **~1.06375**
...
export NUM_LOOPS=2 LOOP_START=4 LOOP_END=5 ENABLE_LOOPING_AT=0.30
...
export RUN_ID="041J-loop45-frac030"

mkdir -p /workspace/runs/041J-loop45-frac030-screen
...
torchrun --standalone --nproc_per_node=4 \
  ...
  >> /workspace/runs/041J-loop45-frac030-screen/train.log 2>&1
```
...
~1.06375. Together with 041H and 041I, maps the frac curve for N=15 (layers 4-5, NL=2).
