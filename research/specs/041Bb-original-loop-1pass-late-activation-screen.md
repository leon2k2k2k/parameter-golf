# Spec 041Bb — original loop (layers 3-5), NUM_LOOPS=1, frac=0.65
...
Original 041B used frac=0.59, landing at ~5911 steps (not 6000). Actual loop
...
export NUM_LOOPS=1 LOOP_START=3 LOOP_END=5 ENABLE_LOOPING_AT=0.65
