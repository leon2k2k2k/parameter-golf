...
SHA="cd74fcc"
ARM="050C2-adabn-early"
RUNDIR="/workspace/runs/050C2-adabn-early-screen"
...
# ── 4. Config — 050C + ENABLE_LOOPING_AT=0.25 ────────────────────────────
...
# Loop — AdaLN only, earlier activation
export NUM_LOOPS=2 LOOP_START=3 LOOP_END=5 ENABLE_LOOPING_AT=0.25
export LOOP_ADABN=1
...
echo "[launch] 050C2 adabn-early screen done."
