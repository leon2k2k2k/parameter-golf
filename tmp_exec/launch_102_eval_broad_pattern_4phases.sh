#!/bin/bash
# Spec 102 — Eval-only COMPOUND: broad pattern + 4 TTT phases (shape × TTT-axis) on, on 060A checkpoint.
#
# Third compound spec — 085 (broad) + 091 (4 phases). Shape × TTT-axis compound. — leaderboard-relevant matched-compute test enabled. Real leaderboard-
...
export SHA="e7ccda2"
export ARM="102-eval-broad-pattern-4phases"
...
export LOOP_PATTERN="1,2,3,3,4,5,4,5,6,5,6,7,7"
...
export PHASED_TTT_NUM_PHASES=4   # ← COMPOUND LEVER 2 (canonical 3)
