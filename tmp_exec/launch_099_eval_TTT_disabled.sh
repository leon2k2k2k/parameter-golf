#!/bin/bash
# Spec 099 — Eval-only TTT-disabled (calibration: how much does TTT contribute?) at canonical NL on, on 060A checkpoint.
#
# Tests TTT_LORA_LR axis at canonical recurrence — sibling to 091/094/095 — TTT lever calibration baseline (sizes the TTT contribution) enabled. Real leaderboard-
...
export SHA="e7ccda2"
export ARM="099-eval-TTT-disabled"
...
export TTT_ENABLED=0       # ← LEVER (canonical 1)
export PHASED_TTT_ENABLED=0   # ← LEVER (canonical 3)
export PHASED_TTT_NUM_PHASES=0  # ← LEVER (canonical 3)
export TTT_LORA_LR=1e-4
# TTT disabled — calibration baseline
