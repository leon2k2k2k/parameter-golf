...
#
# Usage: SEED=42 RUN_LABEL=seed_42 bash launch_110_official.sh
#
...
# Features (1855 stack)
export CASEOPS_ENABLED=1 COMPRESSOR=pergroup   # per-group lrzip; saves ~280 KB vs brotli (#1855's default)
