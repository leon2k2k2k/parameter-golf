#!/bin/bash
# Spec 084 — Eval-only NL=4 equivalent WITH TTT on, on 060A checkpoint.
#
# Composes 081 (NL=4 eq, TTT-off) with TTT — extends 083 to deeper NL enabled. Real leaderboard-
...
export LOOP_PATTERN="1,2,3,4,5,3,4,5,3,4,5,3,4,5,3,4,5,6,7"
