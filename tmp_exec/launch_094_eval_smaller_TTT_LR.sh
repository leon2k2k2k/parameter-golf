#!/bin/bash
# Spec 094 — Eval-only smaller TTT_LORA_LR (5e-5 vs canonical 1e-4) at canonical NL on, on 060A checkpoint.
#
# Tests TTT_LORA_LR axis at canonical recurrence — sibling to 091 (TTT phase count) enabled. Real leaderboard-
...
export SHA="e7ccda2"
export ARM="094-eval-smaller-TTT-LR"
...
export TTT_LORA_LR=5e-5   # ← THE LEVER (was 1e-4)
