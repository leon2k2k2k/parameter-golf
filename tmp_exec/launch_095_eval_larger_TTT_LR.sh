#!/bin/bash
# Spec 095 — Eval-only larger TTT_LORA_LR (2e-4 vs canonical 1e-4) at canonical NL on, on 060A checkpoint.
#
# Tests TTT_LORA_LR axis at canonical recurrence — sibling to 094 (smaller-LR direction); completes LR direction sweep enabled. Real leaderboard-
...
export SHA="e7ccda2"
export ARM="095-eval-larger-TTT-LR"
...
export TTT_LORA_LR=2e-4   # ← THE LEVER (was 1e-4; 094 was 5e-5)
