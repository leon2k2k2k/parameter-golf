#!/bin/bash
# Spec 083 — Eval-only NL=3 equivalent WITH TTT on, on 060A checkpoint.
#
# Composes 080 (NL=3 eq, TTT-off) with TTT enabled. Real leaderboard-
