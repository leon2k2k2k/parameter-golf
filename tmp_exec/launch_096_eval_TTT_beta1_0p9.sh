#!/bin/bash
# Spec 096 — Eval-only TTT_BETA1=0.9 (add momentum to TTT Adam, canonical 0.0) at canonical NL on, on 060A checkpoint.
#
# Tests TTT_LORA_LR axis at canonical recurrence — sibling to 091/094/095 — TTT hyperparameter axis (momentum direction) enabled. Real leaderboard-
...
export SHA="e7ccda2"
export ARM="096-eval-TTT-beta1-0p9"
...
export TTT_BETA1=0.9   # ← THE LEVER (canonical 0.0)
