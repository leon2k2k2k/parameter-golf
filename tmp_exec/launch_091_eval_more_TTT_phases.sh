#!/bin/bash
# Spec 091 — Eval-only more TTT phases (4 vs canonical 3) at canonical NL on, on 060A checkpoint.
#
# Tests TTT-compute axis at canonical recurrence — independent of LOOP_PATTERN axis enabled. Real leaderboard-
...
export SHA="e7ccda2"
export ARM="091-eval-more-TTT-phases"
...
export PHASED_TTT_NUM_PHASES=4   # ← THE LEVER (was 3)
