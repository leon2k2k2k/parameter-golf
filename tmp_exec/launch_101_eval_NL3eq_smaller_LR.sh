#!/bin/bash
# Spec 101 — Eval-only COMPOUND: NL=3 eq + smaller TTT_LORA_LR=5e-5 on, on 060A checkpoint.
#
# Second compound spec — 080 (NL=3 eq) + 094 (smaller TTT LR). Tests deeper-recurrence × LR-tuning composition. enabled. Real leaderboard-
...
export SHA="e7ccda2"
export ARM="101-eval-NL3eq-smaller-LR"
...
export LOOP_PATTERN="1,2,3,4,5,3,4,5,3,4,5,3,4,5,6,7"
...
export TTT_LORA_LR=5e-5   # ← COMPOUND LEVER 2 (canonical 1e-4)
