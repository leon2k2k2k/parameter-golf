...
export NUM_LOOPS=2 LOOP_START=3 LOOP_END=4 ENABLE_LOOPING_AT=0.35
...
echo "=========================================================================="
echo "[launch] 4H Spec 070 — Loop {3,4} NL=2 / SHA=${SHA} / SEED=${SEED} / RUN_LABEL=${RUN_LABEL}"
