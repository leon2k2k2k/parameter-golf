#!/bin/bash
# Spec 097 — Eval-only TTT_BATCH_SIZE=32 (smaller batch, finer-grained adaptation, canonical 64) at canonical NL on, on 060A checkpoint.
#
# Tests TTT_LORA_LR axis at canonical recurrence — sibling to 091/094/095 — TTT hyperparameter axis (batch granularity direction) enabled. Real leaderboard-
...
export SHA="e7ccda2"
export ARM="097-eval-TTT-batch-32"
...
export TTT_BATCH_SIZE=32   # ← THE LEVER (canonical 64)
