#!/bin/bash
# Spec 100 — Eval-only COMPOUND: NL=3 eq + 4 TTT phases on, on 060A checkpoint.
#
# First compound spec — combines 080 (NL=3 eq) + 091 (4 TTT phases). Tests cross-axis composition. enabled. Real leaderboard-
...
export SHA="e7ccda2"
export ARM="100-eval-NL3eq-4phases"
