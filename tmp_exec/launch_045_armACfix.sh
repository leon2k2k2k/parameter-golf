#!/bin/bash
# Spec 045 — Arm AC-fix: LOOP_ITER_EMBEDS=1 LOOP_SCALE_INIT=recip
# True AC baseline (first run where loop_iter_embeds is actually in the optimizer).
# Required comparison point for Arms G and H.
#
...
SHA="7c6ac51"
ARM="armACfix"
RUNDIR="/workspace/runs/045-loop-layer-improvements/armAC-fix-rerun"
...
# TRITON_AUTOTUNE_NUM_RUNS=1 intentionally NOT set — pre-warmed cache has optimal kernels.
