#!/bin/bash
# Spec 110 mini on 4×H100 — 5 min smoke for multi-stream loop body (when 8×H100 unavailable). Per execution memo:
...
#
# Usage: SEED=42 RUN_LABEL=seed_42_4h bash launch_110_mini.sh
...
echo "=========================================================================="
echo "[launch] 4H ADAPTED 060A / SHA=${SHA} / SEED=${SEED} / RUN_LABEL=${RUN_LABEL}"
