#!/bin/bash
# Spec 092 — Eval-only band-shift {2,3,4} WITH TTT on, on 060A checkpoint.
#
# Composes 089 (band {2,3,4} TTT-off) with TTT — leaderboard cell for earlier-shift position enabled. Real leaderboard-
...
export SHA="e7ccda2"
export ARM="092-eval-band-shift-234-TTT"
...
export LOOP_PATTERN="2,3,4,2,3,4,2,3,4,5,6,7"
