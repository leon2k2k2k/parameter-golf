#!/bin/bash
# Spec 111 phase 2 mini on 4×H100 — Anderson training-from-scratch smoke (when 8×H100 unavailable). Per execution memo:
...
#
# Usage: SEED=42 RUN_LABEL=seed_42_4h bash launch_111_mini.sh
