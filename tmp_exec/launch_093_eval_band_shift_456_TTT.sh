#!/bin/bash
# Spec 093 — Eval-only band-shift {4,5,6} WITH TTT on, on 060A checkpoint.
#
# Composes 090 (band {4,5,6} TTT-off) with TTT — completes position × TTT grid with 092 enabled. Real leaderboard-
...
export SHA="e7ccda2"
export ARM="093-eval-band-shift-456-TTT"
...
export LOOP_PATTERN="4,5,6,4,5,6,4,5,6"
