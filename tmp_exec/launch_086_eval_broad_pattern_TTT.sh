#!/bin/bash
# Spec 086 — Eval-only matched-compute broad pattern WITH TTT on, on 060A checkpoint.
#
# Composes 085 (broad-pattern, TTT-off) with TTT — leaderboard-relevant matched-compute test enabled. Real leaderboard-
...
export SHA="e7ccda2"
export ARM="086-eval-broad-pattern-TTT"
