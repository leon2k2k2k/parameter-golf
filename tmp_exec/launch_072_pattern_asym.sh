...
export LOOP_PATTERN="1,2,3,3,4,5,4,5,6,5,7"
...
echo "=========================================================================="
echo "[launch] 4H Spec 072 — Loop pattern asym (1,2,3,3,4,5,4,5,6,5,7) / SHA=${SHA} / SEED=${SEED} / RUN_LABEL=${RUN_LABEL}"
